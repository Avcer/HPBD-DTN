const contentLetterSrart_actived = "Đây là 1 món quà tinh thần nhỏ dành cho em." //Lời mở đầu cho bức thư
const mainContentLetter = "Hôm nay là ngày kỉ niệm tròn 19 năm thiên thần giáng thế ♥. Chúc em sẽ luôn thành công và luôn gặp may mắn trên chặng đường sắp tới. Anh không khéo ăn nói với kiểm soát cảm xúc nên đã nhiều lần gây ra những lỗi lầm không đáng có. Nhưng tình cảm và sự chân thành này là thật. Cuối cùng vẫn là chúc mừng sinh nhật em." //Nội dung của bức thư

// Gắn 1 đường link ảnh bất kì
let imgStart = document.querySelector(".myAI"); //Hình ảnh xuất hiện trong lời mở đầu của bức thư
imgStart.src = "./img/anh-2.jpg";

// Gắn 1 link ảnh bất kì
let imgLetter = document.querySelector(".img");
imgLetter.src = "./img/anh-1.jpg"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
